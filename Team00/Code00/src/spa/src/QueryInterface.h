...
public:
	...
	virtual void addAssignPatternClause(shared_ptr<QueryInput> synonym, shared_ptr<QueryInput> queryInput,
		shared_ptr<Expression> expression) = 0;
	virtual void addContainerPatternClause(shared_ptr<QueryInput> synonym, shared_ptr<QueryInput> queryInput) = 0;
